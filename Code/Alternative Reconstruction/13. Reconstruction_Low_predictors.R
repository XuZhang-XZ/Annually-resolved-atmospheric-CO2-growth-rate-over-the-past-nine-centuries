...
## Read predictors Low latitude region
...
write.csv(predictors,"Output Data/Predictors/PAGS2k_Low predictors.csv",row.names = FALSE)
...
recon=function(parallel.ge){
  ...
  ## Predictors
  predictors=read.csv("Output Data/Predictors/PAGS2k_Low predictors.csv")
  ...
  Write.name=paste0("Z:/2022/Science9_SM/Output Data/Reconstructed CGR/All Ensemble_Low predictors/",parallel.ge,".csv")
...
for(parallel.ge in 1:nparas){
  ...
  ## read
  Read.name=paste0("Z:/2022/Science9_SM/Output Data/Reconstructed CGR/All Ensemble_Low predictors/",parallel.ge,".csv")
...
## Write
write.csv(Total.summary,"Output Data/Reconstructed CGR/SD/Total.summary.sd_Low predictors.csv",row.names = F)

# Comparison --------------------------------------------------------------

## Data
Total.summary1=read.csv("Output Data/Reconstructed CGR/SD/Total.summary.sd.csv")
Total.summary2=read.csv("Output Data/Reconstructed CGR/SD/Total.summary.sd_Low predictors.csv")
