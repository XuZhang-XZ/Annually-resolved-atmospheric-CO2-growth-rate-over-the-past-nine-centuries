...
## Read predictors that are significantly correlated
properties2 = read.csv("Output Data/PAGES 2k v.2.0.0/Properties/Cor.properties.select.csv")
...
write.csv(predictors,"Output Data/Predictors/PAGS2k_Cor predictors.csv",row.names = FALSE)
...
recon=function(parallel.ge){
  ...
  ## Predictors
  predictors=read.csv("Output Data/Predictors/PAGS2k_Cor predictors.csv")
  ...
  Write.name=paste0("Z:/2022/Science9_SM/Output Data/Reconstructed CGR/All Ensemble_Cor predictors/",parallel.ge,".csv")
...
for(parallel.ge in 1:nparas){
  ...
  ## read
  Read.name=paste0("Z:/2022/Science9_SM/Output Data/Reconstructed CGR/All Ensemble_Cor predictors/",parallel.ge,".csv")
...
## Write
write.csv(Total.summary,"Output Data/Reconstructed CGR/SD/Total.summary.sd_Cor predictors.csv",row.names = F)
